    ...
    public class FaqService : IFaqService
    {
        public List<FaqDto> GetAll()
        {
            return new List<FaqDto>()
            {
                ...
                new FaqDto() { Order = 9,  Question = "Сколько максимум товаров я могу выставить в каждом диапазоне цены?", Answer = "По одному товару в каждом диапазоне цены." },
                new FaqDto() { Order = 10, Question = "Я случайно положил в кошелек большую сумму. Могу ли я ее вывести сразу же?", Answer = "Сумму можно выводить одной заявкой до 20000 рублей, выводите без проблем или свяжитесь с нами мы оформим возврат." },
                new FaqDto() { Order = 11, Question = "Есть ли ограничения по покупке пазлов у других пользователей?", Answer = "Ограничений нет." },
                new FaqDto() { Order = 12, Question = "Почему цены на сайте иногда отличаются от цен сторонних сайтов?", Answer = "К сожалению время идет цены меняются, но не волнуйтесь в любом случае мы выполним все возложенные на нас условия в независимости подорожал товар или подешевел." },
            };
        }
    }
}
